...
function Footer() {
    return ( 
        ...
        <div className='container border-top mt-5'>
            ...
            <div>
                    <a href="" className='me-4 ms-4 text-muted' style={{textDecoration:"none"}} >NSE</a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >BSE </a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >MCX</a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >Terms & conditions </a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >Policies & procedures </a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >Privacy policy</a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >Disclosure </a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >For investor's attention </a>
                    <a href="" className='me-4 text-muted' style={{textDecoration:"none"}} >Investor charter</a>
            </div>
        </div>
        </footer>
     );
